...
//Örneğin çözümü:
const KareninAlani = kenarUzunlugu => kenarUzunlugu * kenarUzunlugu;
...
console.log(CemberinAlani(15, pi)); // Test için
...
/*  Bu satırın aşağısındaki kodları lütfen değiştirme
